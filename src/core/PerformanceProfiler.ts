...
export class PerformanceProfiler {
  ...
  private activeOperations: Map<string, { startTime: number; memoryBefore: NodeJS.MemoryUsage; metadata?: any }> = new Map();
   ...
   */
  getMemoryStats(): { current: NodeJS.MemoryUsage; peak: number; average: number } {
