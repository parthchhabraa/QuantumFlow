...
export class ErrorHandler {
  private static errorHistory: DetailedError[] = [];
   ...
   */
  private static findRelatedErrors(code: string, category: ErrorCategory): string[] {
   ...
   */
  private static addToHistory(error: DetailedError): void {
   ...
   */
  static formatError(error: DetailedError, includeDetails: boolean = false): string {
