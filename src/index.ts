...
export { 
  ...
  QuantumMetadata, 
  CompressionStats 
} from './models/CompressedQuantumData';
export { 
  QuantumStateConverter, 
  DataPatternAnalysis, 
  ConversionStats 
} from './core/QuantumStateConverter';
export { 
  QuantumPhaseAssigner, 
  PhaseAssignmentStrategy, 
  PhaseContext, 
  ChunkPhaseInfo 
} from './core/QuantumPhaseAssigner';
export { 
  DataChunker, 
  ChunkingStrategy, 
  DataChunk, 
  ChunkingAnalysis 
} from './core/DataChunker';
export { 
...
} from './core/SuperpositionProcessor';
export { 
  PatternRecognizer, 
  RecognizedPattern, 
  PatternPosition, 
  ...
  InterferencePattern as PatternInterferencePattern, 
