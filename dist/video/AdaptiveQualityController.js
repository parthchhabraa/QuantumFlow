...
class AdaptiveQualityController {
    constructor(config) {
        ...
        this.qualityHistory = [];
        this.recentCompressionResults = [];
        this.maxHistorySize = 100;
        this.qualityChangeThreshold = 0.2; // Minimum change needed to trigger quality adjustment
        this.stabilityWindow = 10; // Number of frames to consider for stability
        this.config = config;
     ...
     */
    forceQuality(quality, reason = 'Manual override') {
     ...
     */
    calculateQualityScore(frameComplexity, networkScore, performanceScore) {
        ...
        const qualityScore = (1 - frameComplexity) * complexityWeight +
     ...
     */
    recordQualityChange(quality, reason) {
     ...
     */
    calculateAverageCompressionRatio(results) {
        if (results.length === 0)
            return 1;
...
//# sourceMappingURL=AdaptiveQualityController.js.map