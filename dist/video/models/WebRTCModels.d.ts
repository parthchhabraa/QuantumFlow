...
export interface BandwidthDistribution {
    ...
    allocatedBandwidth: Map<string, number>;
 ...
 * WebRTC error types
 */
export type WebRTCErrorType = 'connection-failed' | 'signaling-error' | 'ice-gathering-failed' | 'media-access-denied' | 'bandwidth-exceeded' | 'room-full' | 'room-not-found' | 'participant-not-found' | 'compression-failed';
/**
 * WebRTC error
 */
...
//# sourceMappingURL=WebRTCModels.d.ts.map